...
export const describeScenes: DescribeScene[] = [
  ...
  },
  {
    ...
    modelDescription: 'Estoy en un parque grande. Hay muchos árboles verdes. En el centro del parque, veo dos niños jugando con una pelota roja. Un perro marrón está corriendo cerca de ellos. A la izquierda hay un banco dónde una señora está sentada leyendo un libro. Hace sol y el cielo está azul.',
  ...
  },
  {
    ...
    vocabularyTargets: [
      ...
      { spanish: 'la televisión', english: 'the televisión', category: 'object' },
    ...
    modelTranslation: 'This is a modern and comfortable living room. There is a large gray sofa in the center. In front of the sofa there is a wooden coffee table. The televisión is on the wall. Next to the sofa there is a tall lamp. Under the table there is a blue rug. The walls are white.',
    difficulty: 'beginner',
