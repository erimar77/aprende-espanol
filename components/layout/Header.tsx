...
const navigation: NavItem[] = [
  ...
  },
  {
    name: 'Fluency',
    children: [
      { name: '⚡ Workshop', href: '/workshop', description: 'Mixed practice sessions' },
      { name: '💬 Conversation Cards', href: '/conversation-cards', description: 'Real-life practice' },
      { name: 'Speaking Prompts', href: '/prompts', description: 'Free-form speaking' },
      { name: 'Scenarios', href: '/scenarios', description: 'Branching role-play' },
      { name: 'Phrase Bank', href: '/phrases', description: 'Common phrases' },
      { name: 'Immersion', href: '/immersion', description: 'Spanish media & music' },
    ],
  },
  {
    name: 'Practice',
    children: [
      ...
      { name: 'Test', href: '/test', description: 'A1 assessment' },
